...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="./dist/CSS/g-homepage.css"/>
...
<body id="home">
    ...
    <div class="our-house" id="our-house">
        <div class="container">
            ...
            <?php if(auth()->guard()->check()): ?>
                <button onclick="window.location.href = 'ourhouse';">View All House</button>
            <?php else: ?>
                <button onclick="confirmLogin()">View All House</button>
            <?php endif; ?>
            </div>            
        </div>
    </div>
...
</html><?php /**PATH D:\grandeviera trial\resources\views/g-homepage.blade.php ENDPATH**/ ?>