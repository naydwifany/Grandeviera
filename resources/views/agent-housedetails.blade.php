...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="./dist/CSS/agent-housedetails.css"/>
...
<body id="agenthousedetails-page">
    ...
    <!--Agent House Details-->
    <div class="section-agent-house-details">
        <div class="container-page">
            ...
            <div class="two-buttons">
                <a href="agent-edithouse.html" class="btn-edithouse">Edit</a>
