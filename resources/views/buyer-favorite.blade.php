...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="./dist/CSS/buyer-favorite.css"/>
...
<body id="buyerfavorite-page">
    ...
    <!--Buyer Favorite-->
    <div class="section-buyer-favorite">
        <div class="container-page">
            <div class="container-title">
                <h1 data-aos="fade-up" data-aos-duration="1000">Your Favorite</h1>
                <p data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>            
            <div class="container-favorites" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
